...
// fiveHourRemaining returns the account's 5h (Primary) window remaining
// percent, falling back to Secondary if Primary is absent.
...
// weeklyRemaining returns the account's weekly (Secondary) window remaining
// percent, falling back to Primary if Secondary is absent.
