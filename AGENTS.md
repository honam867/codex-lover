...
- Codex auth at `C:\Users\Admin\.codex\auth.json`
- OpenCode auth at `C:\Users\Admin\.local\share\opencode\auth.json`
- runtime state at `C:\Users\Admin\.codex-lover`
...
```powershell
set PATH=C:\Users\Admin\AppData\Local\codex-lover\bin;%PATH%
```
...
git init
git branch -M main
git remote add origin https://github.com/honam867/codex-lover.git
git add .
